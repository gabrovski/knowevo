...
import knowevo.myvizster.controls.HighlightControl;
import knowevo.myvizster.controls.FocusRequester;
import knowevo.myvizster.controls.HighlightHoldControl;
import knowevo.myvizster.controls.ExpansionControl;
import knowevo.myvizster.controls.LinkageControl;
import knowevo.myvizster.controls.ZoomStepControl;
import knowevo.myvizster.action.VizsterXRayColorFunction;
import knowevo.myvizster.action.CommunityConstructor;
import knowevo.myvizster.action.VizsterSizeFunction;
import knowevo.myvizster.action.CommunityFilter;
import knowevo.myvizster.action.VizsterBrowsingColorFunction;
import knowevo.myvizster.action.HighlightSettingAction;
import knowevo.myvizster.action.HighlightAction;
import knowevo.myvizster.action.VizsterLayout;
import knowevo.myvizster.action.InvertToggleAction;
import knowevo.myvizster.action.AuraFilter;
import knowevo.myvizster.action.VizsterFontFunction;
import knowevo.myvizster.action.CommunityLayout;
import knowevo.myvizster.action.CommunityEdgeLabeler;
import knowevo.myvizster.VizsterLib;
import knowevo.myvizster.VizsterItemComparator;
import knowevo.myvizster.DecoratorItem;
import edu.berkeley.guir.prefuse.Display;
import knowevo.myvizster.VizsterDBLoader;
import knowevo.myvizster.VizsterDisplay;
...
import knowevo.myvizster.ui.CommunityPanel;
import knowevo.myvizster.ui.Legend;
import knowevo.myvizster.ui.ProfilePanel;
 ...
 * @author gabrovski
 */
public class VizsterDrawer extends knowevo.myvizster.Vizster {
    ...
    private void initPrefuse() {
        ...
        forces.add(new edu.berkeley.guir.prefuse.action.AbstractAction() {
            public void run(ItemRegistry registry, double frac) {                
                ...
                while ( iter.hasNext() ) {
                    ...
                    if (e instanceof edu.berkeley.guir.prefuse.graph.Node) {
                        NodeItem item = registry.getNodeItem((edu.berkeley.guir.prefuse.graph.Node)e);
        ...
        defaultSet.addFocusListener(new FocusListener() {
            public void focusChanged(FocusEvent e) {
                ...
                for ( int i=0; i < removed.length; i++) {
                    NodeItem n = registry.getNodeItem((edu.berkeley.guir.prefuse.graph.Node)removed[i]);
                    if ( n != null ) { n.setFixed(false); n.setWasFixed(false); }
                }
                
                // set current focus as referrer for newly visible nodes
                edu.berkeley.guir.prefuse.graph.Node added = (edu.berkeley.guir.prefuse.graph.Node)e.getFirstAdded();
        ...
        clickedSet.addFocusListener(new FocusListener() {
            public void focusChanged(FocusEvent e) {
                ...
                edu.berkeley.guir.prefuse.graph.Node f = (edu.berkeley.guir.prefuse.graph.Node)e.getFirstAdded();
                if ( f != null )
