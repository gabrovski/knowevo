 ...
 */
public class MyHighlightHoldControl extends ControlAdapter {
    ...
    public MyHighlightHoldControl(Activity act, Object focusSetKey, VizsterApplet vizster, int mode) {
