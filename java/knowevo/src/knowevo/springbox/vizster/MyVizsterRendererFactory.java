...
import knowevo.myvizster.render.*;
 ...
 */
public class MyVizsterRendererFactory implements RendererFactory {

    private double scaleThreshold = 2;
    
    private VizsterApplet vizster;
    ...
    private MyAuraRenderer auraRenderer;
    
    public MyVizsterRendererFactory(VizsterApplet vizster) {
        ...
        auraRenderer = new MyAuraRenderer(vizster);
    } //
